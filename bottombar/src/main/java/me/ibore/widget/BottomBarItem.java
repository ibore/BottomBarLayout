...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        mIconNormalResourceId = ta.getResourceId(R.styleable.BottomBarItem_bbIconNormal, -1);
        ...
        mIconWidth = ta.getDimensionPixelSize(R.styleable.BottomBarItem_bbIconWidth, 0);
        ...
        mNotifyPointBg = ta.getDrawable(R.styleable.BottomBarItem_bbNotifyPointBg);

        unreadNumThreshold = ta.getInteger(R.styleable.BottomBarItem_bbUnreadThreshold,99);
    }
     ...
     * 设置未读数
     *
     * @param unreadNum 小于等于{@link me.ibore.widget.BottomBarItem#unreadNumThreshold}则隐藏，
     *                  大于0小于{@link me.ibore.widget.BottomBarItem#unreadNumThreshold}则显示对应数字，
     *                  超过{@link me.ibore.widget.BottomBarItem#unreadNumThreshold}
     *                  显示{@link me.ibore.widget.BottomBarItem#unreadNumThreshold}+
     */
